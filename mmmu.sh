...
export FILE=/opt/NeMo/340b_preview10delsys_nv_dpo_mmmu.jsonl
#export LOCAL_RANK=0
#export WORLD_SIZE=8
#export RANK=0
...
python ${NEMO}/examples/multimodal/multimodal_llm/neva/neva_evaluation.py \
   ...
   prompt_file=/opt/NeMo/mmmu/input_llama_format-mmmu_v1_all-test.jsonl \
   inference.media_base_path=/opt/NeMo/mmmu/mmmu_v1_all \
   output_file=${FILE} \
   inference.temperature=0.2 \
   inference.greedy=False \
   inference.add_BOS=False \
   inference.tokens_to_generate=8
